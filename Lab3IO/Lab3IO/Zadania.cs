...
namespace Lab3IO
{
    public class ZadaniaTAP
    {
        ...
        public struct TResultDataStructure
        {
            ...
            public TResultDataStructure(int value1, int value2)
            {
                this.value1 = value1;
                this.value2 = value2;
            }
        ...
        public Task<TResultDataStructure> AsyncMethod1(byte[] buffer)
        {
            ...
            Task.Run(() =>
            {
                tcs.SetResult(new TResultDataStructure(buffer[1], buffer[2]));
            });
            return tcs.Task;
        }
        ...
        public async Task<XmlDocument> Zadanie3(string address)
        {
            ...
            string page = await webClient.DownloadStringTaskAsync(new Uri(address));
